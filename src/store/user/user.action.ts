...
export type SignInSuccess = TActionWithPayload<
  USER_ACTION_TYPES.SIGN_IN_SUCCESS,
  TUserData
>;
export type SignInFailed = TActionWithPayload<
...
export type SignOutFailed = TActionWithPayload<
...
export const signInSuccess = withMatcher(
  (user: TUserData & { id: string }): SignInSuccess =>
