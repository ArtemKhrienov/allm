...
export const BaseButton = styled.button.attrs({
  className: 'flex flex-row w-full items-center justify-center mx-2 my-2 transition duration-150 ease-in-out rounded border ' +
    'focus:outline-none focus:outline-none focus:ring-2 focus:ring-offset-2'
})``

export const WhiteButton = styled(BaseButton).attrs({
  className: 'bg-white text-gray-600 border-gray-300 px-8 py-3 text-sm ' +
